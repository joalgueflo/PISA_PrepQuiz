...
#Clarify where the file is
import pandas as pd
import openpyxl
path_excel= "excelproyectofinal.xlsx"
...
while corre==True:
    ...
    if seccion == 'A' or seccion=='a':
        ...
        #----------------------------Science Opens-----------------------------------
    #Script when you select SCIENCE
        ...
        for i in range(len(columna1_ciencias)):
            ...
            intentos=1
    #------Images for question 6 and 7 in the excel file---------   
            if i == 5:
                init()
                screen = display.set_mode((500,600))
                imagen= image.load(r'Images/ADNPhoto.jpg')
                ...
                while True:
                    ...
                    display.flip()
                    break     
#--------------------------Closes Images for This problems---------------------------------------- 
            ...
            if respuesta != columna2_ciencias[i] and intentos==3:
                #Prints the answer and the explanation
                print()
...
#----------------------------Science Closes-----------------------------------
    ...
    #----------------------------Literature Opnes-----------------------------------
    #Script for when you select LITERATURE
...
#Images for question 6 and 7 in the excel file  
            if i == 0:
                ...
                init()
                screen = display.set_mode((500,600))
                imagen= image.load(r'Images/Graffiti.jpg')
                imagen = transform.scale(imagen,(500,600))
                ...
                init()
                screen = display.set_mode((500,600))
                imagen= image.load(r'Images/ChadLake.jpg')
                imagen = transform.scale(imagen,(500,600))
                ...
                init()
                screen = display.set_mode((500,600))
                imagen= image.load(r'Images/TheBike.jpg')
                imagen = transform.scale(imagen,(500,600))
                ...
                init()
                screen = display.set_mode((500,600))
                imagen= image.load(r'Images/BuenosAires.jpg')
                imagen = transform.scale(imagen,(500,600))
...
#Code for spinning donut from:
#Code, G. (2020). Python/Pygame 3D ASCII Spinning Donut Tutorial [YouTube Video]. 
# In YouTube. https://www.youtube.com/watch?v=zn4Yvxww58g&ab_channel=GiovanniCode
